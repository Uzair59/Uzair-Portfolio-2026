...
export function Projects() {
  ...
  return (
    <>
      ...
      {/* Modal outside Section to avoid CSS conflicts */}
    ...
    <AnimatePresence>
      {project && (
        ...
        >
          ...
          {/* Centered Modal */}
          <div className="fixed inset-0 flex items-center justify-center p-4 sm:p-6 pb-20">
            <motion.div
              role="dialog"
              aria-modal="true"
            ...
            >
              <div className="glass grain  max-h-[80vh] overflow-y-auto rounded-[28px] p-6 shadow-2xl md:p-8">
                {/* Close button */}
                <button
                  type="button"
                  onClick={onClose}
                  className="absolute right-4 top-4 z-20 rounded-2xl border border-black/10 bg-white/80 p-2 text-soft transition hover:bg-white/90 dark:border-white/10 dark:bg-black/50 dark:hover:bg-black/70"
                  aria-label="Close"
                >
                ...
                {/* Content */}
                {project.image && (
                  <div className="relative mb-5 aspect-video overflow-hidden rounded-[22px] border border-black/10 bg-black/5 dark:border-white/10 dark:bg-black/20">
                    <Image
                      src={project.image}
